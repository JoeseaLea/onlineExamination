...
<html>
  ...
  <center>
  	<h1>请填写判断题信息</h1>
    <form action="addQuestionBankJudgeAction" method="post">
    	<input type="hidden" name="questionBankJudgeBean.teachername" value="${user.name }">
    	<table>
    		<tr>
    			<td>所属课程</td>
    			<td>
    		...
    		<tr>
    			<td>题目</td>
    			<td>
    				<textarea rows="10" cols="30" name="questionBankJudgeBean.question"></textarea>
    			</td>
    		</tr>
    		<tr>
    			<td>答案</td>
