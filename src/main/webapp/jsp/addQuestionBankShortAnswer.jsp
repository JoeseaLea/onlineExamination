...
<html>
  ...
  <center>
  	<h1>请填写简答题信息</h1>
    <form action="addQuestionBankShortAnswerAction" method="post">
    	<input type="hidden" name="questionBankShortAnswerBean.tearchername" value="${user.name }">
    	<table>
    		<tr>
    			<td>所属课程</td>
    			<td>
    		...
    		<tr>
    			<td>题目</td>
    			<td>
    				<textarea rows="10" cols="30" name="questionBankShortAnswerBean.question"></textarea>
    			</td>
    		</tr>
    		<tr>
    			<td>答案</td>
    			<td>
    				<textarea rows="10" cols="30" name="questionBankShortAnswerBean.answer"></textarea>
    			</td>
    		</tr>
    		<tr>
