...
<html>
  ...
  <br><br><br><br>
  	<center>
    <form action="examingFillAction" method="post" onsubmit="return test();">
    	...
    	<table border="1" bordercolor="#C6E6FF" cellspacing="0" width="75%">
    		<tr>
    			<td width="100%" align="center">当前题型：填空题&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;题号:${index+1 }</td>
    		</tr>
    		<tr>
    			<td>
    				<textarea rows="8" cols="120" name="paperFillBean.question" readonly="readonly">${listPaperFillBean[index].question }</textarea>
    			</td>
    		</tr>
    		<tr>
    			<td>
    				请在下面输入答案，多个答案以逗号分隔
    				<br><textarea rows="4" cols="120" name="paperFillBean.studentanswer" >${listPaperFillBean[index].studentanswer }</textarea>
    			</td>
    		</tr>
    		<tr>
    			<td align="center">
