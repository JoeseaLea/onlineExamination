...
<html>
  ...
  <center>
  	<h1>请填写填空题信息</h1>
    <form action="updateQuestionBankFillAction" method="post">
    	<input type="hidden" name="questionBankFillBean.id" value="${questionBankFillBean.id }">
    	<input type="hidden" name="questionBankFillBean.teachername" value="${questionBankFillBean.teachername }">
    	<table>
    		<tr>
    			<td>所属课程</td>
    			<td>
    				<select name="questionBankFillBean.courseid">
    					<c:forEach items="${listCourseBean }" var="courseBean">
    						<c:if test="${courseBean.id==questionBankFillBean.courseid }">
    		...
    		<tr>
    			<td>题目</td>
    			<td>
    				<textarea rows="10" cols="30" name="questionBankFillBean.question">${questionBankFillBean.question }</textarea>
    			</td>
    		</tr>
    		<tr>
    			<td>答案</td>
    			<td>
    				<textarea rows="5" cols="30" name="questionBankFillBean.answer">${questionBankFillBean.answer }</textarea>
    			</td>
    		</tr>
    		<tr>
